...
insert.insert_Provider_Information("test_provider_first_name","test_provider_last_name","test_provider_gender","test_provider_username","test_provider_password",select.select_person_type_id("test_person_type_name"),select.select_status_id("test_status_name"))
insert.insert_Survey_Activity(select.select_patient_id("test_patient_first_name"),"test_rating","test_rating_date")